...
export const galleryItems: GalleryItem[] = [
  ...
  { image: "https://cdn.poehali.dev/files/935e74b3-a8a6-4963-9ca5-f84fd3812b02.jpg", alt: "Ремешок для фототехники от Армы Грей", title: "Ремешок для фототехники от Армы Грей" }
];