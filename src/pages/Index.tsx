    ...
    <div className="min-h-screen relative">
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="container mx-auto text-center animate-fade-in">
          <h2 className="text-5xl md:text-7xl font-bold mb-6 leading-tight text-center text-red-900" style={{ fontFamily: "'Great Vibes', cursive" }}>Магия и искусство оформления</h2>
