    ...
    <div className="min-h-screen relative">
        ...
        <nav className="container mx-auto px-4 py-4 flex items-center justify-between relative z-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground font-semibold text-right mx-0">Багетная мастерская</p>
            </div>
          </div>
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="container mx-auto text-center animate-fade-in">
          <h2 className="text-5xl md:text-7xl mb-6 leading-tight text-center text-red-900" style={{ fontFamily: "'Great Vibes', cursive" }}>Магия и искусство оформления</h2>
...
Самый большой выбор багета. Самые короткие сроки оформления. Самые честные цены.</p>
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-28 right-6 hover:bg-red-800 text-white p-4 rounded-full shadow-lg transition-all duration-300 hover:scale-110 z-50 bg-gray-900"
          aria-label="Наверх"
        >
